// Copyright (c) 2014 Andrey Sidorov (sidorares@yandex.ru) and contributors
// https://github.com/sidorares/node-wrk/blob/master/lib/parseWrk.js
export default function parseWrk(stdout) {
